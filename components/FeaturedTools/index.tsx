            ...
            <div className="mx-auto max-w-[340px] px-3 sm:max-w-screen-2xl sm:px-6 lg:px-8">
                ...
                <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    {featuredTools.map((tool) => (
                        ...
                        >
                            <Card className="group relative flex h-full w-full flex-col border-border/50 bg-card/80 p-8 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:border-primary/40 hover:shadow-xl hover:shadow-primary/10 dark:hover:shadow-primary/5">
                                {tool.badge && (
