  ...
  const renderInputArea = () => {
        ...
        <div className={styles.inputSection}>
          ...
          {isDataUrl(inputText) && (
            <div className={styles.dataUrlInfo}>
              ...
              <small>MIME Type: {getMimeTypeFromDataUrl(inputText)}</small>
            </div>
          )}
        </div>
      );
    ...
    return (
      <div className={styles.inputSection}>
        <div className={styles.sectionHeader}>
          <h3>
            {fileType === "image" ? "🖼️ Image Input" : "📦 Binary File Input"}
          </h3>
          {isProcessing && (
            <div className={styles.progressBar}>
              <div
        ...
        >
          {fileInfo?.previewUrl && fileType === "image" ? (
            ...
            <div className={styles.dropContent}>
              ...
              <p>Drag & drop a {fileType} file here or click to browse</p>
              <small>
        ...
        {fileInfo && !fileInfo.previewUrl && (
          <div className={styles.fileInfoCard}>
            ...
            <div className={styles.fileInfoDetails}>
              <div className={styles.fileInfoName}>{fileInfo.name}</div>
              <div className={styles.fileInfoMeta}>
                <span>Size: {(fileInfo.size / 1024).toFixed(2)} KB</span>
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.actionBar}>
          <button
            ...
            disabled={
              isProcessing ||
              (mode === "encode" ? isEncodeDisabled : isDecodeDisabled)
            }
          >
            {isProcessing
              ? "Processing..."
          ...
          <div className={styles.decodeImageSection}>
            <div className={styles.imagePreviewCard}>
              <div className={styles.imagePreviewHeader}>
                ...
                <h3 className={styles.imagePreviewTitle}>Decoded Image</h3>
                <span className={styles.imageFormatBadge}>
                  {decodeResult.mimeType?.split("/")[1]?.toUpperCase() ||
                    "IMAGE"}
                </span>
              </div>
            ...
            <div className={styles.metadataCard}>
              ...
              <div className={styles.metadataGrid}>
                ...
                {decodeResult.imageDimensions && (
                  <div className={styles.metadataItem}>
                    ...
                    <span className={styles.metadataValue}>
                      ...
                      {decodeResult.imageDimensions.height} px
                    </span>
                  </div>
                )}
                ...
                <div className={styles.metadataItem}>
                  <span className={styles.metadataLabel}>Base64 Length</span>
                  <span className={styles.metadataValue}>
                    {decodeResult.data.split(",")[1]?.length.toLocaleString() ||
                ...
                <div className={styles.metadataItem}>
                  ...
                  <span className={styles.metadataValue}>
                    {decodeResult.imageDimensions
                      ? (
                          decodeResult.imageDimensions.width /
                          decodeResult.imageDimensions.height
                        ).toFixed(2)
                      : "Unknown"}
                  </span>
                </div>
                ...
                <div className={styles.metadataItem}>
                  <span className={styles.metadataLabel}>Color Depth</span>
                  <span className={styles.metadataValue}>24-bit</span>
                </div>
              </div>
            </div>
          ...
          <div className={styles.decodeBinarySection}>
            ...
            <div className={styles.binaryInfo}>
              <div className={styles.binaryInfoRow}>
                <span>File Type:</span>
                <strong>{decodeResult.mimeType || "Unknown"}</strong>
              </div>
              <div className={styles.binaryInfoRow}>
                <span>Size:</span>
                <strong>
                  {((decodeResult.size || 0) / 1024).toFixed(2)} KB
                </strong>
              </div>
              <div className={styles.binaryInfoRow}>
                <span>Base64 Length:</span>
                <strong>
                  {decodeResult.data.length.toLocaleString()} chars
                </strong>
              </div>
            </div>
          ...
          <div className={styles.outputSection}>
            <div className={styles.sectionHeader}>
              ...
              <span className={styles.outputLength}>
                Length: {outputText.length.toLocaleString()} chars
              </span>
            </div>
            ...
            {!isLargeOutput ? (
              ...
              <div className={styles.largeOutputWarning}>
                <span>⚠️</span>
                <p>
                  Output is very large ({outputText.length.toLocaleString()}{" "}
                  characters).
                </p>
                <p>Use Copy or Download buttons below to save the result.</p>
              </div>
            )}
        ...
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoCard}>
            ...
            <div className={styles.infoContent}>
              <h4>Common Uses</h4>
              <p>
                Email attachments, data URLs, API authentication, storing binary
                data in JSON, and embedding images in HTML/CSS.
              </p>
            </div>
          </div>
          <div className={styles.infoCard}>
            ...
            <div className={styles.infoContent}>
              <h4>Pro Tips</h4>
              <p>
                Base64 increases data size by ~33%. Supports Unicode, emoji, and
