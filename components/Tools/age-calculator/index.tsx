...
//                                         Enter your birth details to calculate
//                                         your age
//                                     </p>
//                                 </div>
...
//                                         />
//                                         <span
//                                             className={styles.vedicToggleSlider}
//                                         ></span>
//                                         <span
//                                             className={styles.vedicToggleLabel}
//                                         >
//                                             🌙 Calculate Indian Vedic Rashi
//                                             (Moon Sign)
//                                         </span>
//                                     </label>
//                                 </div>
...
//                                             <div
//                                                 className={styles.zodiacContent}
//                                             >
//                                                 <div
//                                                     className={
//                                                         styles.zodiacMain
...
//                                                     <div
//                                                         className={
//                                                             styles.zodiacSymbolDisplay
//                                                         }
//                                                     >
//                                                         <span
//                                                             className={
//                                                                 styles.zodiacSymbolLarge
//                                                             }
//                                                         >
//                                                             {
...
//                                                         🌙
//                                                     </span>
//                                                     Indian Vedic Rashi (Moon
//                                                     Sign)
//                                                 </h4>
//                                                 <p
//                                                     className={
//                                                         styles.rashiSubtitle
//                                                     }
//                                                 >
//                                                     Based on Moon position at
//                                                     birth
//                                                 </p>
//                                             </div>
...
//                                                         <div
//                                                             className={
//                                                                 styles.rashiSymbolDisplay
//                                                             }
//                                                         >
//                                                             <span
//                                                                 className={
//                                                                     styles.rashiSymbolLarge
//                                                                 }
//                                                             >
//                                                                 {
//                                                                     vedicRashi.symbol
...
//                                                         }
//                                                     >
//                                                         Enable Vedic Rashi and
//                                                         provide birth time &
//                                                         place for accurate Moon
//                                                         sign calculation.
//                                                     </p>
//                                                 </div>
//                                             )}
...
//                                             <div className={styles.sameAgeIcon}>
//                                                 🎯
//                                             </div>
//                                             <div
//                                                 className={
//                                                     styles.sameAgeMessage
//                                                 }
//                                             >
//                                                 {comparisonResult.message}
//                                             </div>
...
const AgeCalculator = () => {
    ...
    const calculateAge = () => {
        ...
        setAge({
            ...
            totalDays,
            daysUntilBirthday,
            birthDayName: birth.toLocaleDateString("en-US", {
                weekday: "long",
            }),
        })
    }
                    ...
                    <div className="p-5 sm:p-6">
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-slate-200/80 bg-white/60 px-3 py-2 text-sm text-slate-800 transition focus:border-blue-400 focus:ring-1 focus:ring-blue-400 focus:outline-none dark:border-slate-800/60 dark:bg-slate-900/60 dark:text-slate-100 dark:focus:border-blue-500"
                            />
                        </div>
