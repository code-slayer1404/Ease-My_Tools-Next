...
const COMPREHENSIVE_FOOD_DATABASE = [
    ...
    },
    {
        ...
        fiber: 1.4,
        sugar: 23,
        vitamins: { vitaminC: 27, vitaminK: 28, vitaminB6: 6 },
        minerals: { potassium: 6, copper: 6, manganese: 5 },
    ...
    },
    {
        ...
        fiber: 2.3,
        sugar: 13,
        vitamins: { vitaminC: 17, vitaminA: 10, vitaminE: 5 },
        minerals: { potassium: 8, copper: 5, manganese: 3 },
        antioxidants: ["Chlorogenic acid", "Beta-carotene", "Lutein"],
        benefits: ["Skin health", "Digestive health", "Immune support"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 42,
    },
    {
        ...
        fiber: 5.5,
        sugar: 17,
        vitamins: { vitaminC: 12, vitaminK: 10, vitaminB6: 2 },
        minerals: { potassium: 6, copper: 8, manganese: 4 },
        antioxidants: ["Quercetin", "Flavonoids", "Vitamin C"],
        benefits: ["Digestive health", "Heart health", "Anti-inflammatory"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 38,
    },
    {
        ...
        fiber: 3.2,
        sugar: 20,
        vitamins: { vitaminC: 18, vitaminA: 3, vitaminK: 4 },
        minerals: { potassium: 10, copper: 5, manganese: 5 },
        antioxidants: ["Anthocyanins", "Quercetin", "Melatonin"],
        benefits: ["Sleep quality", "Anti-inflammatory", "Exercise recovery"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 22,
    },
    {
        ...
        fiber: 2.1,
        sugar: 6,
        vitamins: { vitaminC: 71, vitaminK: 23, vitaminE: 5 },
        minerals: { potassium: 7, copper: 6, manganese: 3 },
        antioxidants: ["Vitamin C", "Lutein", "Zeaxanthin"],
        benefits: ["Immune support", "Digestive health", "Heart health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 50,
    },
    {
        ...
        fiber: 2.5,
        sugar: 8,
        vitamins: { vitaminC: 144, vitaminA: 31, folate: 13 },
        minerals: { potassium: 11, magnesium: 7, copper: 2 },
        antioxidants: ["Lycopene", "Beta-carotene", "Papain"],
        benefits: ["Digestive health", "Skin health", "Immune support"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 60,
    },
    {
        ...
        fiber: 1.6,
        sugar: 14,
        vitamins: { vitaminC: 108, vitaminA: 120, folate: 8 },
        minerals: { potassium: 14, magnesium: 5, manganese: 3 },
        antioxidants: ["Beta-carotene", "Lutein", "Zeaxanthin"],
        benefits: ["Eye health", "Hydration", "Immune support"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 65,
    },
    {
        ...
        fiber: 8,
        sugar: 5,
        vitamins: { vitaminC: 54, manganese: 41, vitaminK: 12 },
        minerals: { potassium: 6, magnesium: 7, copper: 5 },
        antioxidants: ["Ellagic acid", "Anthocyanins", "Quercetin"],
        benefits: ["Anti-inflammatory", "Heart health", "Blood sugar control"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 32,
    },
    {
        ...
        fiber: 7.6,
        sugar: 7,
        vitamins: { vitaminC: 50, vitaminK: 36, manganese: 47 },
        minerals: { potassium: 7, magnesium: 8, copper: 8 },
        antioxidants: ["Anthocyanins", "Ellagic acid", "Flavonoids"],
        benefits: ["Brain health", "Anti-inflammatory", "Heart health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 25,
    },
    {
        ...
        fiber: 0.9,
        sugar: 7,
        vitamins: { vitaminC: 10, vitaminK: 5, vitaminA: 5 },
        minerals: { potassium: 4, copper: 2, manganese: 2 },
        antioxidants: ["Anthocyanins", "Chlorogenic acid", "Quercetin"],
        benefits: ["Digestive health", "Bone health", "Heart health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 40,
    },
    ...
    },
    {
        ...
        fiber: 3.3,
        sugar: 1.2,
        vitamins: { vitaminE: 37, thiamine: 20, vitaminB6: 8 },
        minerals: { manganese: 76, copper: 25, magnesium: 12 },
        antioxidants: ["Proanthocyanidins", "Vitamin E", "Flavonoids"],
        benefits: ["Heart health", "Brain function", "Skin health"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 3.7,
        sugar: 20,
        vitamins: { vitaminK: 6, vitaminB6: 4, vitaminA: 2 },
        minerals: { potassium: 8, calcium: 5, magnesium: 6 },
        antioxidants: ["Flavonoids", "Phenolic acids", "Vitamin E"],
        benefits: ["Bone health", "Digestive health", "Heart health"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 61,
    },
    {
        ...
        fiber: 3,
        sugar: 22,
        vitamins: { vitaminK: 28, vitaminA: 14, vitaminB6: 4 },
        minerals: { potassium: 10, magnesium: 5, copper: 7 },
        antioxidants: [
            "Neochlorogenic acid",
            "Chlorogenic acid",
            "Caffeic acid",
    ...
    },
    {
        ...
        fiber: 1.1,
        sugar: 1.4,
        vitamins: { vitaminE: 13, vitaminK: 17, vitaminB1: 14 },
        minerals: { manganese: 121, magnesium: 17, zinc: 12 },
        antioxidants: ["Lutein", "Zeaxanthin", "Vitamin E"],
        benefits: ["Heart health", "Eye health", "Energy production"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 15,
    },
    {
        ...
        fiber: 3.9,
        sugar: 1,
        vitamins: { vitaminE: 82, thiamine: 43, vitaminB6: 23 },
        minerals: { selenium: 42, phosphorus: 32, manganese: 30 },
        antioxidants: ["Vitamin E", "Selenium", "Flavonoids"],
        benefits: ["Heart health", "Thyroid function", "Skin health"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 20,
    },
    {
        ...
        fiber: 2,
        sugar: 0.4,
        vitamins: { vitaminK: 18, vitaminB2: 10, vitaminB6: 5 },
        minerals: { magnesium: 42, zinc: 28, iron: 23 },
        antioxidants: ["Antioxidants", "Carotenoids", "Vitamin E"],
        benefits: ["Prostate health", "Heart health", "Sleep quality"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 10,
    },
    {
        ...
        fiber: 3.8,
        sugar: 0.2,
        vitamins: { vitaminB1: 15, vitaminB6: 5, folate: 6 },
        minerals: { manganese: 17, magnesium: 11, phosphorus: 9 },
        antioxidants: ["Lignans", "Alpha-linolenic acid"],
        benefits: ["Heart health", "Digestive health", "Hormone balance"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 35,
    },
    {
        ...
        fiber: 9.8,
        sugar: 0,
        vitamins: { calcium: 18, magnesium: 23, phosphorus: 22 },
        minerals: { manganese: 30, selenium: 16, copper: 3 },
    ...
    },
    {
        ...
        fiber: 2.1,
        sugar: 0.1,
        vitamins: { vitaminB6: 11, thiamine: 13, folate: 5 },
        minerals: { copper: 73, manganese: 22, calcium: 18 },
        antioxidants: ["Sesamin", "Sesamolin", "Vitamin E"],
        benefits: ["Bone health", "Heart health", "Anti-inflammatory"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 35,
    },
    {
        ...
        fiber: 3,
        sugar: 2,
        vitamins: { manganese: 17, copper: 11, selenium: 8 },
        minerals: { iron: 5, phosphorus: 4, magnesium: 4 },
        antioxidants: ["Phenolic compounds", "Cytokinins"],
        benefits: ["Energy production", "Heart health", "Metabolism"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 42,
    },
    ...
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB6: 48, niacin: 37, vitaminB12: 9 },
        minerals: { selenium: 46, phosphorus: 26, zinc: 12 },
        antioxidants: ["Selenium"],
        benefits: ["Muscle building", "Weight loss", "Metabolism"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { thiamine: 65, vitaminB6: 35, vitaminB12: 15 },
        minerals: { selenium: 47, phosphorus: 24, zinc: 12 },
        antioxidants: ["Coenzyme Q10"],
        benefits: ["Muscle growth", "Energy production", "Nerve function"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 45, niacin: 28, vitaminB6: 15 },
        minerals: { zinc: 39, selenium: 26, iron: 12 },
        antioxidants: ["Conjugated linoleic acid"],
        benefits: ["Muscle building", "Immune support", "Energy production"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 33, vitaminB6: 10, vitaminD: 9 },
        minerals: { selenium: 47, phosphorus: 20, potassium: 10 },
        antioxidants: ["Selenium"],
        benefits: ["Heart health", "Weight management", "Thyroid function"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 149, vitaminD: 45, niacin: 25 },
        minerals: { calcium: 38, selenium: 52, phosphorus: 49 },
        antioxidants: ["Coenzyme Q10"],
        benefits: ["Bone health", "Heart health", "Anti-inflammatory"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 21, selenium: 54, vitaminE: 5 },
        minerals: { phosphorus: 20, copper: 13, zinc: 10 },
        antioxidants: ["Astaxanthin"],
        benefits: ["Heart health", "Brain function", "Weight management"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 408, selenium: 49, zinc: 59 },
        minerals: { copper: 97, phosphorus: 31, magnesium: 16 },
        antioxidants: ["Selenium"],
        benefits: ["Immune support", "Brain health", "Bone health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 42, selenium: 53, copper: 89 },
        minerals: { zinc: 37, phosphorus: 28, magnesium: 12 },
        antioxidants: ["Selenium"],
        benefits: ["Brain health", "Thyroid function", "Heart health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 20, manganese: 340, selenium: 64 },
        minerals: { iron: 32, phosphorus: 22, zinc: 13 },
        antioxidants: ["Omega-3 fatty acids"],
        benefits: ["Heart health", "Brain function", "Immune support"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 324, zinc: 605, copper: 223 },
        minerals: { selenium: 63, iron: 37, manganese: 18 },
        antioxidants: ["Zinc", "Selenium"],
        benefits: ["Immune support", "Sexual health", "Heart health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0.3,
        sugar: 0,
        vitamins: { calcium: 35, manganese: 21, selenium: 14 },
        minerals: { copper: 11, phosphorus: 11, iron: 9 },
        antioxidants: ["Isoflavones", "Saponins"],
        benefits: ["Heart health", "Bone health", "Hormone balance"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { manganese: 54, copper: 26, phosphorus: 22 },
        minerals: { magnesium: 16, iron: 13, calcium: 11 },
        antioxidants: ["Isoflavones", "Saponins"],
        benefits: ["Muscle building", "Gut health", "Heart health"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 15,
    },
    {
        ...
        fiber: 8,
        sugar: 3,
        vitamins: { vitaminK: 41, folate: 121, vitaminC: 16 },
        minerals: { manganese: 62, iron: 20, phosphorus: 34 },
        antioxidants: ["Isoflavones", "Saponins"],
        benefits: ["Muscle building", "Heart health", "Bone health"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 18,
    },
    {
        ...
        fiber: 16,
        sugar: 4,
        vitamins: { folate: 90, manganese: 49, iron: 37 },
        minerals: { phosphorus: 36, copper: 25, potassium: 21 },
    ...
    },
    {
        ...
        fiber: 13,
        sugar: 8,
        vitamins: { folate: 71, manganese: 84, copper: 29 },
        minerals: { phosphorus: 28, iron: 26, zinc: 17 },
        antioxidants: ["Polyphenols", "Flavonoids"],
        benefits: ["Heart health", "Blood sugar control", "Digestive health"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 28,
    ...
    },
    {
        ...
        fiber: 2.5,
        sugar: 5,
        vitamins: { vitaminC: 169, vitaminA: 13, vitaminB6: 17 },
        minerals: { potassium: 6, manganese: 6, vitaminK: 8 },
        antioxidants: ["Capsanthin", "Violaxanthin", "Lutein"],
    ...
    },
    {
        ...
        fiber: 2.1,
        sugar: 2,
        vitamins: { vitaminC: 77, vitaminK: 20, vitaminB6: 11 },
        minerals: { potassium: 8, manganese: 8, folate: 14 },
        antioxidants: ["Glucosinolates", "Isothiocyanates", "Carotenoids"],
        benefits: ["Cancer prevention", "Heart health", "Brain health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    {
        ...
        fiber: 3.3,
        sugar: 2,
        vitamins: { vitaminC: 125, vitaminK: 274, vitaminA: 15 },
        minerals: { manganese: 18, folate: 24, potassium: 9 },
        antioxidants: ["Kaempferol", "Isothiocyanates", "Glucosinolates"],
        benefits: ["Cancer prevention", "Anti-inflammatory", "Heart health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    {
        ...
        fiber: 2.8,
        sugar: 2.5,
        vitamins: { vitaminK: 70, folate: 67, vitaminC: 12 },
        minerals: { potassium: 6, phosphorus: 5, vitaminA: 18 },
        antioxidants: ["Glutathione", "Rutin", "Quercetin"],
        benefits: ["Digestive health", "Anti-aging", "Heart health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    {
        ...
        fiber: 1.4,
        sugar: 3,
        vitamins: { vitaminC: 35, vitaminB6: 10, vitaminK: 9 },
        minerals: { manganese: 8, potassium: 8, magnesium: 5 },
        antioxidants: ["Lutein", "Zeaxanthin", "Beta-carotene"],
        benefits: ["Weight management", "Heart health", "Eye health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    ...
    // LEGUMES (30 items)
    {
        ...
        fiber: 15,
        sugar: 0.6,
        vitamins: { folate: 64, manganese: 38, thiamine: 28 },
        minerals: { iron: 20, magnesium: 30, phosphorus: 24 },
    ...
    },
    {
        ...
        fiber: 13,
        sugar: 0.6,
        vitamins: { folate: 58, manganese: 33, thiamine: 16 },
        minerals: { iron: 22, potassium: 25, phosphorus: 24 },
        antioxidants: ["Anthocyanins", "Flavonoids"],
        benefits: ["Heart health", "Blood sugar control", "Weight management"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 29,
    ...
    // SEAFOOD (30 items)
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 317, selenium: 63, vitaminD: 90 },
        minerals: { phosphorus: 28, magnesium: 19, potassium: 14 },
        antioxidants: ["Omega-3 fatty acids"],
        benefits: ["Heart health", "Brain function", "Anti-inflammatory"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 0,
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminB12: 570, selenium: 47, vitaminD: 42 },
        minerals: { phosphorus: 25, potassium: 12, magnesium: 11 },
        antioxidants: ["Omega-3 fatty acids"],
        benefits: ["Heart health", "Brain development", "Anti-inflammatory"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 0,
    },
    ...
    // ROOT VEGETABLES (20 items)
    {
        ...
        fiber: 3.8,
        sugar: 9,
        vitamins: { folate: 37, manganese: 22, vitaminC: 11 },
        minerals: { potassium: 9, iron: 6, magnesium: 6 },
        antioxidants: ["Betalains", "Vulgaxanthin"],
        benefits: ["Blood pressure", "Exercise performance", "Detoxification"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 64,
    },
    {
        ...
        fiber: 2.3,
        sugar: 5,
        vitamins: { vitaminC: 30, vitaminK: 26, folate: 8 },
        minerals: { potassium: 8, manganese: 7, calcium: 5 },
    ...
    // BERRIES (20 items)
    {
        ...
        fiber: 4.6,
        sugar: 4,
        vitamins: { vitaminC: 22, vitaminE: 8, vitaminK: 5 },
        minerals: { manganese: 18, copper: 7, potassium: 2 },
        antioxidants: ["Proanthocyanidins", "Anthocyanins", "Quercetin"],
        benefits: ["Urinary health", "Heart health", "Anti-inflammatory"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 45,
    },
    {
        ...
        fiber: 3.6,
        sugar: 13,
        vitamins: { vitaminA: 150, vitaminC: 15, vitaminB2: 14 },
        minerals: { selenium: 25, iron: 11, zinc: 9 },
        antioxidants: ["Zeaxanthin", "Beta-carotene", "Polysaccharides"],
    ...
    // MUSHROOMS (15 items)
    {
        ...
        fiber: 0.7,
        sugar: 1.6,
        vitamins: { vitaminB2: 29, vitaminB3: 21, vitaminB5: 15 },
        minerals: { selenium: 17, copper: 16, potassium: 9 },
        antioxidants: ["Ergothioneine", "Glutathione"],
        benefits: ["Immune support", "Heart health", "Cancer prevention"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    {
        ...
        fiber: 3,
        sugar: 7,
        vitamins: { vitaminB5: 33, vitaminB6: 17, vitaminD: 12 },
        minerals: { copper: 65, selenium: 33, zinc: 9 },
        antioxidants: ["Lentinan", "Ergothioneine"],
        benefits: ["Immune support", "Heart health", "Cancer prevention"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    ...
    // HERBS & SPICES (25 items)
    {
        ...
        fiber: 0.7,
        sugar: 0,
        vitamins: { manganese: 17, iron: 9, vitaminB6: 5 },
        minerals: { potassium: 4, copper: 3, magnesium: 2 },
        antioxidants: ["Curcumin", "Turmerone"],
    ...
    },
    {
        ...
        fiber: 0.2,
        sugar: 0.1,
        vitamins: { vitaminB6: 2, magnesium: 1, potassium: 1 },
        minerals: { manganese: 2, copper: 1, iron: 1 },
        antioxidants: ["Gingerol", "Shogaol", "Paradol"],
        benefits: ["Anti-inflammatory", "Nausea relief", "Digestive health"],
        bestFor: ["weightLoss", "maintenance"],
        timing: "With meals or tea",
    },
    ...
    // FERMENTED FOODS (15 items)
    {
        ...
        fiber: 1.6,
        sugar: 2,
        vitamins: { vitaminC: 33, vitaminK: 59, vitaminB6: 12 },
        minerals: { iron: 14, folate: 20, sodium: 21 },
        antioxidants: ["Lactobacillus", "Isothiocyanates"],
        benefits: ["Gut health", "Immune support", "Anti-inflammatory"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    {
        ...
        fiber: 4.1,
        sugar: 3,
        vitamins: { vitaminC: 35, vitaminK: 23, vitaminB6: 11 },
        minerals: { iron: 12, folate: 15, sodium: 39 },
        antioxidants: ["Lactobacillus", "Isothiocyanates"],
        benefits: ["Gut health", "Immune support", "Digestive health"],
        bestFor: ["weightLoss", "maintenance"],
        glycemicIndex: 15,
    },
    ...
    // OILS & FATS (20 items)
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminE: 13, vitaminK: 8 },
        minerals: {},
        antioxidants: ["Oleuropein", "Hydroxytyrosol"],
        benefits: ["Heart health", "Anti-inflammatory", "Brain health"],
        bestFor: ["weightGain", "maintenance"],
    },
    {
        id: 1502,
        ...
        benefits: ["Energy boost", "Brain function", "Skin health"],
        bestFor: ["weightGain", "maintenance"],
    },
    ...
    // SWEETENERS (10 items)
    {
        ...
        benefits: ["Antioxidant", "Cough relief", "Energy boost"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 58,
    },
    {
        ...
        fiber: 0,
        sugar: 12,
        vitamins: { manganese: 33, zinc: 8, calcium: 3 },
        minerals: { potassium: 2, magnesium: 2 },
        antioxidants: ["Phenolic compounds"],
        benefits: ["Antioxidant", "Mineral source", "Energy boost"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 54,
    },
    ...
    // MEAT ALTERNATIVES (15 items)
    {
        ...
        fiber: 1,
        sugar: 0,
        vitamins: { iron: 8, selenium: 5 },
        minerals: { phosphorus: 8, calcium: 4 },
        antioxidants: [],
    ...
    },
    {
        ...
        fiber: 4,
        sugar: 0,
        vitamins: { iron: 15, phosphorus: 12 },
        minerals: { magnesium: 8, zinc: 6 },
        antioxidants: ["Isoflavones"],
        benefits: ["High protein", "Heart health", "Weight management"],
        bestFor: ["weightGain", "maintenance"],
        glycemicIndex: 15,
    },
    ...
    // FUNCTIONAL FOODS (20 items)
    {
        ...
        fiber: 0.3,
        sugar: 0,
        vitamins: { vitaminB1: 14, vitaminB2: 20, iron: 11 },
        minerals: { copper: 21, manganese: 7, potassium: 3 },
        antioxidants: ["Phycocyanin", "Beta-carotene"],
        benefits: ["Immune support", "Detoxification", "Energy boost"],
        bestFor: ["weightLoss", "maintenance"],
        timing: "With meals",
    },
    {
        ...
        fiber: 0,
        sugar: 0,
        vitamins: { vitaminA: 60, iron: 20, zinc: 10 },
        minerals: { magnesium: 8, phosphorus: 5 },
        antioxidants: ["Chlorophyll", "Lutein"],
        benefits: ["Detoxification", "Immune support", "Digestive health"],
        bestFor: ["weightLoss", "maintenance"],
        timing: "With meals",
    },
...
const NutritionMaster = () => {
    ...
    const filteredFoods = useMemo(() => {
        return COMPREHENSIVE_FOOD_DATABASE.filter((food) => {
            ...
            const matchesGoal =
                selectedGoal === "all" || food.bestFor.includes(selectedGoal)
    ...
    const addToCompare = (food) => {
        if (
            ...
            !compareList.find((item) => item.id === food.id)
        ) {
    ...
    const getVitaminPercentage = (vitamin, amount) => {
        ...
        return dailyValues[vitamin]
            ? Math.round((amount / dailyValues[vitamin]) * 100)
            : 0
    }
    ...
    const getMineralPercentage = (mineral, amount) => {
        ...
        return dailyValues[mineral]
            ? Math.round((amount / dailyValues[mineral]) * 100)
            : 0
    }
            ...
            <div className={styles["master-container"]}>
                ...
                <div className={styles["controls-section"]}>
                    <div className={styles["search-box"]}>
                        <input
                            type="text"
                            placeholder={
                                "Search foods, fruits, dry fruits, supplements..."
                            }
                            value={searchTerm}
                    ...
                    {filteredFoods.map((food) => (
                        ...
                        >
                            <div className={styles["food-header"]}>
                                <h3>{food.name}</h3>
                                <span className={styles["food-category"]}>
                                    {t(food.category)}
                                </span>
                            </div>
                            ...
                            <div className={styles["food-best-for"]}>
                                {food.bestFor.map((goal) => (
                                    <span
                                        key={goal}
                                        className={`${styles["goal-tag"]} ${goal}`}
                                    >
                                        {t(goal)}
                                    </span>
                                ))}
                        ...
                        <div className={styles["detail-content"]}>
                            <div className={styles["nutrition-facts"]}>
                                ...
                                <div className={styles["facts-grid"]}>
                                    <div className={styles["fact-item"]}>
                                        <span className={styles["fact-label"]}>
                                            {"Calories"}
                                        </span>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        style={{
                                                            width: `${Math.min(getVitaminPercentage(vitamin, amount), 100)}%`,
                                                        }}
                                                    ></div>
                                                </div>
                                                <span
                                                    className={
                                                        styles["vitamin-amount"]
                                                    }
                                                >
                                                    {String(amount)}%
                                                </span>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        style={{
                                                            width: `${Math.min(getMineralPercentage(mineral, amount), 100)}%`,
                                                        }}
                                                    ></div>
                                                </div>
                                                <span
                                                    className={
                                                        styles["mineral-amount"]
                                                    }
                                                >
                                                    {String(amount)}%
                                                </span>
                            ...
                            {selectedFood.antioxidants.length > 0 && (
                                <div className={styles["antioxidants-section"]}>
                                    <h3>{"Antioxidants"}</h3>
                                    <div
                                        className={styles["antioxidants-list"]}
                                    >
                                        {selectedFood.antioxidants.map(
                                            (antioxidant, index) => (
                                                <span
                                                    key={index}
                                                    className={
                ...
                {compareList.length > 0 && (
                    <div className={styles["compare-section"]}>
                        <h3>
                            {"Compare Foods"} ({compareList.length}/5)
                        </h3>
                            ...
                            {compareList.map((food) => (
                                ...
                                >
                                    ...
                                    <div className={styles["compare-macros"]}>
                                        <div
                                            className={styles["macro-compare"]}
                                        >
                                            <span>Calories</span>
