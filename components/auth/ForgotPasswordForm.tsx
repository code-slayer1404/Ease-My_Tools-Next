    ...
    return (
      ...
      >
        ...
        >
          <Link
            href="/login"
            className="inline-block w-full py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-medium hover:from-indigo-500 hover:to-purple-500 transition-all duration-300"
          >
  ...
  return (
    <div>
          ...
          <div key={s} className="flex items-center gap-2">
            ...
            {s < 3 && (
              <div className={`w-12 h-0.5 transition-all duration-300 ${
                s < step ? 'bg-indigo-600' : 'bg-white/10'
              }`} />
            )}
          </div>
        ))}
      ...
      <div className="flex justify-between text-xs text-gray-500 mb-8 px-2">
        <span className={step >= 1 ? 'text-indigo-400' : ''}>Email</span>
        <span className={step >= 2 ? 'text-indigo-400' : ''}>Verify</span>
        <span className={step >= 3 ? 'text-indigo-400' : ''}>Reset</span>
      </div>
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 1 && (
          ...
          >
            <div>
              <h3 className="text-xl font-semibold text-white mb-2">Forgot your password?</h3>
          ...
          >
            <div>
              <button
                type="button"
                onClick={() => setStep(1)}
                className="inline-flex items-center gap-2 text-sm text-foreground hover:text-white transition-colors mb-4"
              >
                <ArrowLeft className="h-4 w-4" />
                Back
              </button>
              ...
              <div className="flex gap-2 justify-between">
                {formData.verificationCode.map((digit, index) => (
                  <input
                    ...
                    className="w-12 h-14 bg-white/5 border border-white/10 rounded-lg text-center text-2xl font-bold text-white focus:outline-none focus:border-indigo-500/50 transition-colors"
                  />
                ))}
              </div>
            ...
            <div className="text-center">
              {countdown > 0 ? (
                <p className="text-sm text-gray-500">
                  Resend code in <span className="text-indigo-400 font-medium">{countdown}s</span>
                </p>
              ) : (
                <button
                  type="button"
        ...
        {step === 3 && (
          ...
          >
            ...
            <div className="space-y-2 text-sm text-foreground bg-white/5 rounded-lg p-4">
