  ...
  image: [
    {
      ...
      seoContent: {
        h1: "Image Resizer",
        intro:
          "Resize images to exact dimensions in seconds while keeping visual quality suitable for web and sharing.",
        howToUse: [
          "Upload an image.",
        ...
        faqs: [
          {
            ...
            answer:
              "Resizing can affect detail, but the tool is optimized to keep results clear for normal web use.",
          },
          {
            question: "Can I resize for specific platforms?",
            answer:
              "Yes, you can enter exact dimensions to match any platform requirement.",
          },
        ],
        relatedTools: [
          { slug: "image-compressor", name: "Image Compressor" },
          { slug: "remove-background", name: "Remove Background" },
          { slug: "profile-pic-optimizer", name: "Profile Picture Optimizer" },
        ],
      },
    },
    {
      ...
      seoContent: {
        h1: "Image Compressor",
        intro:
          "Compress image files to smaller sizes while keeping useful visual quality for websites, email, and sharing.",
        howToUse: [
        ...
        faqs: [
          {
            ...
            answer:
              "WebP and AVIF typically produce smaller files than older formats for many images.",
          },
          {
            question: "Can I keep metadata?",
            answer:
              "Yes, you can choose whether metadata is preserved when compressing.",
          },
        ],
        relatedTools: [
    ...
    },
    {
      ...
      seo: {
        ...
        keywords:
          "profile picture optimizer, social media photo, image resizer for social media, profile photo editor, facebook profile picture, instagram profile photo",
      },
      seoContent: {
        h1: "Profile Picture Optimizer",
        intro:
          "Crop, resize, and enhance profile photos for social platforms in one click.",
        howToUse: [
          "Upload your photo.",
        ...
        faqs: [
          {
            ...
            answer:
              "It works best with single-person shots, but you can manually adjust the crop area.",
          },
          {
            question: "Will the photo quality be reduced?",
            answer:
              "The output is optimized for social media use; noticeable loss is minimal.",
          },
        ],
        relatedTools: [
          { slug: "image-resizer", name: "Image Resizer" },
    ...
    },
    {
      ...
      seo: {
        ...
        keywords:
          "video thumbnail generator, extract thumbnails, youtube thumbnail, video to thumbnail, thumbnail maker",
      },
      seoContent: {
        h1: "Video Thumbnail Generator",
        intro:
          "Capture a frame from your video and save it as a thumbnail image.",
        howToUse: [
          "Upload a video file.",
        ...
        faqs: [
          {
            ...
            answer:
              "The tool focuses on picking and converting; complementary generation may be added later.",
          },
          {
        ...
        faqs: [
          {
            ...
            answer:
              "The output resolution matches your chosen size; scaling down preserves sharpness.",
          },
          {
            question: "Can I convert PNG to SVG?",
            answer:
              "This tool is primarily SVG to raster; for raster to SVG, try the Image to SVG tool.",
          },
        ],
        relatedTools: [
          { slug: "image-to-svg", name: "ImageToSvg" },
    ...
    },
    {
      ...
      seoContent: {
        h1: "Image to SVG",
        intro:
          "Convert PNG, JPG, WEBP and other raster images into scalable SVG vectors with advanced tracing.",
        howToUse: [
          "Upload your image.",
        ...
        faqs: [
          {
            ...
            answer:
              "Yes, but best results are achieved with logos, icons and illustrations.",
          },
          {
            question: "Which image formats are supported?",
            answer:
              "PNG, JPG, JPEG, WEBP, GIF, BMP and other common formats are supported.",
          },
        ],
        relatedTools: [
          { slug: "svg-converter", name: "SvgConverter" },
    ...
    },
    {
      ...
      seoContent: {
        ...
        intro:
          "Remove distracting backgrounds from photos and keep focus on your subject with a simple upload workflow.",
        howToUse: [
          "Upload an image.",
        ...
        faqs: [
          {
            ...
            answer:
              "Clear JPG or PNG images with a visible subject generally produce the best cutout results.",
          },
          {
        ...
        faqs: [
          {
            ...
            answer:
              "Large files may be processed slowly; keep videos under a few minutes for best results.",
          },
          {
        ...
        faqs: [
          {
            ...
            answer:
              "Yes, sentence case capitalizes the first letter of each sentence.",
          },
          {
            question: "Can I undo a transformation?",
            answer:
              "Keep your original text; the tool outputs a transformed copy.",
          },
        ],
        relatedTools: [
        ...
        faqs: [
          {
            ...
            answer:
              "Rates are fetched from a reliable source and updated regularly.",
          },
          {
  ...
  text: [
        ...
        faqs: [
          {
            ...
            answer:
              "Character count can include or exclude spaces depending on the view.",
          },
          {
      ...
      seoContent: {
        ...
        faqs: [
          ...
          },
          {
            ...
            answer:
              "It works well with typical file sizes; extremely large files may slow the browser.",
          },
        ],
        relatedTools: [
    ...
    },
    {
      ...
      seoContent: {
        ...
        intro:
          "Pull images out of PDF documents without manually taking screenshots page by page.",
        howToUse: [
        ...
        faqs: [
          {
            ...
            answer:
              "It extracts embedded images. Some vector-only content may need separate handling.",
          },
          {
            question: "Is my upload stored permanently?",
            answer:
              "The page is designed for quick processing workflows rather than long-term storage.",
          },
        ],
        relatedTools: [
          { slug: "file-converter", name: "File Converter" },
  ...
  calculators: [
    {
      ...
      seoContent: {
        ...
        intro:
          "Find percentages, percentage increases, and more with a simple interface.",
        howToUse: [
          "Enter the values.",
    ...
    },
    {
      ...
      seoContent: {
        h1: "Time Calculator",
        intro:
          "Perform time addition, subtraction, and conversion between units.",
        howToUse: [
          "Enter time values.",
          "Choose operation.",
          "Get the result.",
...
description: "Encrypt and decrypt files securely using AES-256 encryption directly in your browser.",
},
seoContent: {
...
{ slug: "file-converter", name: "File Converter" },
        ...
        faqs: [
          {
            ...
            answer:
              "The tool applies the new names; it’s recommended to keep backups.",
          },
          {
            question: "Does it support regular expressions?",
            answer:
              "Basic find-and-replace is available; regex may be added later.",
          },
        ],
        relatedTools: [
          { slug: "file-converter", name: "File Converter" },
    ...
    },
    {
      ...
      seoContent: {
        h1: "File Converter",
        intro:
          "Convert files into compatible formats so they are easier to share, upload, and use across tools.",
        howToUse: [
        ...
        faqs: [
          {
            ...
            answer:
              "Support depends on the converter setup for this tool. Use the available options shown in the UI.",
          },
          {
            question: "Can I convert large files?",
            answer:
              "Large files may take longer. Keep file sizes reasonable for best performance.",
          },
        ],
        relatedTools: [
          { slug: "pdf-image-extractor", name: "PDF Image Extractor" },
          { slug: "csv-to-json", name: "CSV to JSON" },
          { slug: "image-compressor", name: "Image Compressor" },
        ],
      },
  ...
  web: [
    ...
    },
    {
      ...
      seoContent: {
        h1: "SSL Checker",
        intro:
          "Inspect the SSL certificate of a website for validity and details.",
        howToUse: [
          "Enter a domain name.",
          "Click check.",
        ...
        faqs: [
          {
            ...
            answer:
              "It only retrieves certificate information, not page content.",
          },
          {
            question: "Can I check any domain?",
            answer:
              "Yes, as long as it has a publicly accessible SSL certificate.",
          },
        ],
        relatedTools: [
          { slug: "url-encoder", name: "URL Encoder" },
        ...
        faqs: [
          {
            ...
            answer:
              "It provides a ballpark figure; actual costs vary by region and developer.",
          },
          {
            question: "Does it include hosting?",
            answer:
              "The estimate covers development; hosting and domain are separate.",
          },
        ],
        relatedTools: [
          { slug: "percentage-calculator", name: "Percentage Calculator" },
  ...
  generators: [
        ...
        faqs: [
          {
            ...
            answer:
              "Currently it generates traditional Latin-like placeholder text.",
          },
          {
            question: "Is there a word limit?",
            answer:
              "You can generate up to a reasonable amount for browser performance.",
          },
        ],
        relatedTools: [
          { slug: "word-counter", name: "Word Counter" },
    ...
    },
    {
      ...
      seoContent: {
        ...
        intro:
          "Generate random, secure passwords with adjustable length and character sets.",
        howToUse: [
      ...
      seoContent: {
        ...
        faqs: [
          ...
          },
          {
            ...
            answer:
              "The focus is on macros; vitamin tracking may be added later.",
          },
        ],
        relatedTools: [
          { slug: "percentage-calculator", name: "Percentage Calculator" },
...
export const getToolCategoryBySlug = (slug) => {
  return (
    Object.entries(toolsByCategory).find(([, tools]) =>
